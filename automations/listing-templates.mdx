...
If you are [creating a new listing](/listings/create), you'll be able to use your created listing templates to fill in standard details.
...
<Note>Changes made to listing templates will apply immediately to all listings that use that email template.</Note>
