...
2. Visit your [Settings](https://listingopen.com/settings) page.
3. Select the "Categories" tab - this is where you'll find a list of all your listing categories.
4. Search for and click on the category you're looking for.
5. Change the category's name or delete it.
6. Once done, click on "Save & Publish" to save your changes.
