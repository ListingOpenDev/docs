...
To get started, visit the [Create Listings](https://listingopen.com/listings/new) page.
...
Next, you wille be asked to add integrations. You can either use an [integration package](/automations/integration-packages) or manually add integrations.
